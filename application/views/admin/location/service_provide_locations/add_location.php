            ...
            <div class="panel">
               ...
               <div class="panel-body paddig">
				  ...
				  $attributes = array('name'=>'add_service_location_form','id'=>'add_service_location_form');
                     echo form_open(URL_SERVICE_LOCATIONS.DS.$operation,$attributes) ?>
			    ...
			    <div class="form-group">                    
					 ...
					 echo form_input('locality',$val);?>
                         ...
                         <div class="form-group">
                             <label>Taxa de Entrega: (R$) <span style="color:red;">*</span></label>
                             <?php
                             $val = set_value('txentrega');
                             if(isset($record->txentrega)) {
                                 $val = $record->txentrega;
                             }
                             echo form_input('txentrega',$val);
                             ?>
                         </div>
